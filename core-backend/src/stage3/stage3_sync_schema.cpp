...
void StageSync::init_schema() const {
  ...
  stage3_db_.execute("CREATE TABLE IF NOT EXISTS " + table_feature_tensor + R"( (
        ...
        return_sq_sum_10w HUGEINT NOT NULL DEFAULT 0,
        return_count_10w BIGINT NOT NULL DEFAULT 0,
        ...
        ps_return_sq_sum_10w HUGEINT NOT NULL DEFAULT 0,
        ps_return_count_10w BIGINT NOT NULL DEFAULT 0,
