...
void StageSync::init_schema() const {
  ...
  stage3_db_.execute("CREATE TABLE IF NOT EXISTS " + table_feature_tensor + R"( (
        ...
        return_sum_10w BIGINT NOT NULL DEFAULT 0,
        return_tw_sum_10w HUGEINT NOT NULL DEFAULT 0,
        return_sq_tw_sum_10w HUGEINT NOT NULL DEFAULT 0,
        first_block_10w BIGINT NOT NULL DEFAULT 0,
        ...
        ps_return_sum_10w BIGINT NOT NULL DEFAULT 0,
        ps_return_tw_sum_10w HUGEINT NOT NULL DEFAULT 0,
        ps_return_sq_tw_sum_10w HUGEINT NOT NULL DEFAULT 0,
        ps_time_sum_10w BIGINT NOT NULL DEFAULT 0,
