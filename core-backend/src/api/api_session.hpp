...
private:
  ...
  void handle_rebuild_status() {
    ...
    json result = {
        ...
        {"cnt_cond_amm", p.cnt_cond_amm},
        {"cnt_cond_normal", p.cnt_cond_normal},
        {"cnt_cond_negrisk", p.cnt_cond_negrisk},
        ...
        {"cnt_non_usdc_fpmm", p.cnt_non_usdc_fpmm},
        {"cnt_non_polymarket", p.cnt_non_polymarket},
    };
