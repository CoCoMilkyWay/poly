...
private:
  ...
  void handle_rebuild_status() {
    ...
    json result = {
        ...
        {"xfer_split", p.xfer_split},
        {"xfer_merge", p.xfer_merge},
        ...
        {"xfer_transfer_in", p.xfer_transfer_in},
        {"xfer_transfer_out", p.xfer_transfer_out},
        {"xfer_internal_mint", p.xfer_internal_mint},
        {"xfer_internal_burn", p.xfer_internal_burn},
        {"xfer_internal_transfer", p.xfer_internal_transfer},
        {"xfer_non_usdc", p.xfer_non_usdc},
